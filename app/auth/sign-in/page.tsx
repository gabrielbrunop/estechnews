...
export const metadata: Metadata = {
  title: `Fazer login - ${configs.title}`
}
...
export default async function Page() {
  ...
  return (
    <div className="w-full flex flex-col gap-5 items-center my-10">
      <h1 className="text-3xl font-bold">Seja bem-vindo de volta</h1>
      <AuthForm action={signIn}>
        ...
        <Link href="/auth/reset-password" className="text-blue-600 pl-1">Esqueci minha senha</Link>
        <AuthSubmit />
      </AuthForm>
      <Link href="/auth/sign-up" className="text-blue-600 font-medium">Não tenho uma conta</Link>
